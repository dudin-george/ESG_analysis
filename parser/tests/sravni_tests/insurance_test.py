...
class TestSravniInsurance(TestMixin):
    insurance = SravniBankInfo(bank_id=1, sravni_id=1, sravni_old_id=1, alias="test", bank_name="test", bank_full_name="test", bank_official_name="test")
    ...
    @pytest.fixture
    def setup_bank_page(self, setup_test_reviews, mock_sravni_insurance_reviews_response, mock_sravni_insurance_list) -> requests_mock.Mocker:
