...
def upgrade() -> None:
    ...
    op.create_foreign_key('text_result_text_sentence_id_fkey_cascade', 'text_result', 'text_sentence', ['text_sentence_id'], ['id'], ondelete='CASCADE')
    op.drop_constraint('text_sentence_text_id_fkey', 'text_sentence', type_='foreignkey')
    op.create_foreign_key('text_sentence_text_id_fkey_cascade', 'text_sentence', 'text', ['text_id'], ['id'], ondelete='CASCADE')
...
def downgrade() -> None:
    ...
    op.create_foreign_key('text_result_text_sentence_id_fkey', 'text_result', 'text_sentence', ['text_sentence_id'], ['id'])
    # ### end Alembic commands ###
