...
def upgrade() -> None:
    ...
    op.alter_column("aggregate_table_model_result", "neutral", existing_type=sa.INTEGER(), nullable=False)
...
def downgrade() -> None:
    ...
    op.alter_column("aggregate_table_model_result", "neutral", existing_type=sa.INTEGER(), nullable=True)
