...
class Datasets(Enum):
    ...
    word_2_vec = "w2v.npz"
    rubert_base_sentence = "rubert_base_sentence.npz"
    rubert_base_parsed = "rubert_base_parsed.npz"
    rubert_reviews_sentence = "rubert_reviews_sentence.npz"
    rubert_reviews_parsed = "rubert_reviews_parsed.npz"
